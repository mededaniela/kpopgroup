...
public class KpopgroupController {
	...
	public String save(Model model, @Valid Kpopgroup kpopgroup, BindingResult bindingResult, Generation generation) {
		if (bindingResult.hasErrors()) {
			model.addAttribute("generations", generationRepository.findAll());
			bindingResult.rejectValue("kpopgroupname", "err.kpopgroupname", "Please enter kpop group's name");
			return "addkpopgroup";
		} else {
